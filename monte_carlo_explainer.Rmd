...
With a way to generate data from a triangle distribution, it's pretty straight-forward to build a simulation and estimate some values. I will do that another night.
